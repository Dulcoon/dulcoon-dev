...
const whatsappUrl = "https://wa.me/6282253400079?text=Halo%2C%20saya%20ingin%20mendiskusikan%20proyek%20baru.";

const ServicesCTA = () => (
  <section style={{ padding: "0 48px 80px" }}>
    <div
      className="max-w-[1900px] mx-auto relative overflow-hidden rounded-xl"
      style={{
        background: "#111411",
